...
{
    SetupGraphScreen("Ambient Temperature (Celsius)", AMB_TEMP_VAL_LOW, AMB_TEMP_VAL_HIGH);
}
...
{
    SetupGraphScreen("Motor Temperature (Celsius)", MOTOR_TEMP_VAL_LOW, MOTOR_TEMP_VAL_HIGH);
}
